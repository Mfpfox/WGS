"""
variant_calling_SOP.sh : notes for minerva WGS GATK analysis - CAD12 and CAD63 iPSC lines
...
## TODO :
[] include multiqc .sh step for README
[] include vep annotation .sh for README
...
# -------------------
# Funcotator alternative to local vep run
# -------------------
