...
### I used picard samsort function to solve my intial issues completing this step. TLDR; markduplicatesSpark is designed to do both sorting & deduplication, and by separating sorting and deduplication, you can avoid run time and I/O consumption issues with markduplicatesSpark
...
# STEP 9: Variant Functional Annotation
